...
// Legacy types for backward compatibility - these map domain models to component expectations
import type { FilterOptions } from "@/lib/domain/models";
...
// Fetch players filtered by season - now uses service layer
...
// Fetch all players from all teams - now uses service layer
