...
const siteConfig = {
  ...
  description: 'Elite basketball league in Ottawa featuring competitive divisions, player development, and championship tournaments. Register your team today.',
  url: 'https://nchoopscircuit.com',
...
export function generateMetadata({
  ...
  return {
    ...
    authors: authors ? authors.map(name => ({ name })) : [{ name: 'National Capital Hoops Circuit' }],
...
export function generateOrganizationSchema() {
  return {
    ...
    name: 'National Capital Hoops Circuit',
    alternateName: 'NCHC',
    description: 'Elite basketball league in Ottawa featuring competitive divisions, player development, and championship tournaments.',
    url: 'https://nchoopscircuit.com',
    logo: `${siteConfig.url}/nchh-logo.webp`,
    image: `${siteConfig.url}/og-image.jpg`,
    email: 'info@nchoopscircuit.com',
    sport: 'Basketball',
    address: {
      '@type': 'PostalAddress',
    ...
    sameAs: [
      'https://www.instagram.com/nchoopscircuit/',
    ],
    foundingDate: '2024',
    memberOf: {
      '@type': 'Organization',
