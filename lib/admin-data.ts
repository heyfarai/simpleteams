...
export const sampleTeamRegistrations: TeamRegistration[] = [
  {
    ...
    seasonId: "2024",
    status: "approved",
    divisionPreference: "Elite Division",
...
export function getTeamRegistrationsByTeamId(teamId: string): TeamRegistration[] {
...
export function getTeamRegistrationsBySeasonId(seasonId: string): TeamRegistration[] {
  // Placeholder for team registrations data
  return []
}
