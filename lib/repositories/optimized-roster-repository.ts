// Optimized Roster Repository - handles temporal team/player relationships
import { createClient } from '@supabase/supabase-js';
import type { Team, Player, Season, Division } from '@/lib/domain/models';
...
export class OptimizedRosterRepository {
