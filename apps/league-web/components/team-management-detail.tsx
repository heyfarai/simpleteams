...
export function TeamManagementDetail() {
  ...
  const [teamData, setTeamData] = useState({
    ...
    description:
      "The ONL-X Senior are a competitive basketball team known for their fast-paced offense and tenacious defense.",
  });
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Manage team details and roster
            </p>
          </div>
        </div>
        <Button
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setTeamData({ ...teamData, division: value })
                    }
                    disabled={!isEditing}
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      <SelectItem value="Men's Open Division">
                        Men's Open Division
                      </SelectItem>
                      <SelectItem value="Women's Competitive">
                        Women's Competitive
                      </SelectItem>
                      <SelectItem value="Youth U18">Youth U18</SelectItem>
                      <SelectItem value="Recreational League">
                        Recreational League
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setTeamData({ ...teamData, coach: e.target.value })
                    }
                    disabled={!isEditing}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setTeamData({ ...teamData, coachEmail: e.target.value })
                    }
                    disabled={!isEditing}
                  />
                </div>
            ...
            <CardContent className="space-y-3">
              <div className="text-sm">
                ...
                <div className="text-muted-foreground">
                  Jordan Williams joined the team
                </div>
