...
export default function RegisterPage() {
  ...
  const activeSeasons = sampleAdminSeasons.filter(
    (season) => season.status === "active"
  );
  const selectedSeasonData = sampleAdminSeasons.find(
    (s) => s.id === selectedSeason
  );

  const handleRegistrationSubmit = async (
    registrationData: Partial<TeamRegistration>
  ) => {
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Your team registration has been submitted successfully. You
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-sm text-blue-700 space-y-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          League admin will review your registration (1-3
                          business days)
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          You'll be notified of approval and division assignment
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Register your team for the upcoming basketball season. Complete the
        ...
        <div className="max-w-md mx-auto mb-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose the season you want to register for
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Select
