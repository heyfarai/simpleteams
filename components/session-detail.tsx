...
import { Calendar, Clock, MapPin, Users, Plus, Filter, ArrowLeft } from "lucide-react"
import Link from "next/link"
import { getSessionById, getGamesBySession, getAdminTeamById, getLocationById, getDivisionById } from "@/lib/admin-data"
...
export function SessionDetail({ sessionId }: SessionDetailProps) {
  ...
  const filteredGames = games.filter((game) => {
    const matchesDivision = divisionFilter === "all" || game.divisionId === divisionFilter
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={() => setShowCreateGameModal(true)} className="bg-orange-600 hover:bg-orange-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Select value={divisionFilter} onValueChange={setDivisionFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="div-1">Elite Division</SelectItem>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  <div className="flex-1">
                    ...
                    {game.notes && <p className="text-sm text-gray-600 mt-2">{game.notes}</p>}
                  </div>
      ...
      {filteredGames.length === 0 && (
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <Button onClick={() => setShowCreateGameModal(true)} className="mt-4 bg-orange-600 hover:bg-orange-700">
              Schedule First Game
            </Button>
          </CardContent>
        </Card>
