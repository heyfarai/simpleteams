  ...
  const newsItems = [
    {
      ...
      excerpt:
        "The highly anticipated playoff season kicks off next Monday with four exciting matchups",
      author: "League Staff",
    ...
    },
    {
      ...
      excerpt:
        "New partnership brings equipment discounts to all league participants",
      author: "Admin Team",
    ...
    },
    {
      ...
      excerpt:
        "Featured player leading ONL-X Senior to an impressive season record",
