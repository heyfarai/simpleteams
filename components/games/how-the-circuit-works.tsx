  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="grid md:grid-cols-3 gap-6 text-left">
        <div className="bg-muted/30 rounded-lg md:p-2">
          <div className="flex items-center gap-3">
            <div className="text-5xl mutant-outline text-primary mb-2 ">12</div>
            <h3 className="text-xl font-semibold mb-2">Games Total</h3>
          </div>
        ...
        <div className="bg-muted/30 rounded-lg md:p-2">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-semibold mb-2">Monthly Sessions</h3>
          </div>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="bg-muted/30 rounded-lg md:p-2">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-semibold mb-2">Playoffs</h3>
          </div>
          <p className="text-sm text-muted-foreground">
