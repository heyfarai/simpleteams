...
import { adminSampleData, sampleTeamRegistrations, sampleTeamInvoices, type AdminSeason } from "@/lib/admin-data"
...
export function AdminDashboard() {
  ...
  const dashboardStats = {
    ...
    pendingTeams: sampleTeamRegistrations.filter((r) => r.status === "pending").length,
    pendingPayments: sampleTeamInvoices.filter((i) => i.status === "pending").length,
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 mb-2">League Admin Dashboard</h1>
          <p className="text-gray-600">Multi-tenant basketball league management</p>
        </div>
        <div className="flex items-center gap-4">
          <Badge variant="secondary" className="flex items-center gap-2">
            <Shield className="h-4 w-4" />
            <span className="text-gray-900">{userRole === "league_admin" ? "League Admin" : "Team Admin"}</span>
          </Badge>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{dashboardStats.totalSeasons}</div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{dashboardStats.activeSeasons}</div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{dashboardStats.totalTeams}</div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{dashboardStats.totalLocations}</div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{dashboardStats.totalOfficials}</div>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{dashboardStats.pendingTeams}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {activeSeasons.length > 0 ? (
                    ...
                    <p className="text-gray-600 text-center py-4">No active seasons</p>
                  )}
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">
                      Thunder Bolts registered for 2024-25 Championship Season
                    </p>
                ...
                <div className="flex items-center gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">New location "Thunder Arena" added to system</p>
                ...
                <div className="flex items-center gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">Fire Hawks team registration pending approval</p>
        ...
        <TabsContent value="seasons" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600">Season management features will be available here.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="resources" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">Manage league venues and facilities.</p>
                <Button asChild>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">Manage referees and game officials.</p>
                <Button asChild>
    ...
    <div className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <Badge variant={season.isActive ? "default" : "secondary"}>{season.status}</Badge>
      ...
      <div className="grid grid-cols-3 gap-4 text-center mb-4">
        <div>
          <div className="text-lg font-bold text-gray-900">{totalConferences}</div>
          <div className="text-xs text-gray-600">Conferences</div>
        </div>
        <div>
          <div className="text-lg font-bold text-gray-900">{totalDivisions}</div>
